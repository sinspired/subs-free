        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public WebResourceResponse shouldInterceptRequest(WebView view, WebResourceRequest request) {
                ...
                if (request.getUrl().getHost() != null &&
                    ...
                    // WebViewAssetLoader only serves GET resources. Forward
                    // POST/PUT/DELETE requests to the Go asset handler so
                    // local API actions work inside the Android WebView.
                    if (!"GET".equalsIgnoreCase(request.getMethod())) {
                        ...
                        headers.put("Access-Control-Allow-Origin", "*");
                        headers.put("Cache-Control", "no-cache");
                        String mime = bridge.getAssetMimeType(path == null ? "/" : path);
                        return new WebResourceResponse(
